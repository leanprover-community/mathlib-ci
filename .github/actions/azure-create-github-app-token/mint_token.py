...
def main() -> None:
    ...
    expiration_seconds = parse_expiration_seconds(
        os.environ.get("INPUT_JWT_EXPIRATION_SECONDS", str(JWT_EXPIRATION_SECONDS)).strip()
    )
    ...
    token, installation_id = mint_installation_token(GITHUB_API_URL, app_jwt, owner, repositories_raw)
